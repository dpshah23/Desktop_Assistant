...
mapps = {'calculator': 'calc', 'calender': 'outlookcal:', 'clock': 'ms-clock:', 'paint': 'mspaint',
         'notepad':  'notepad', 'wordpad': 'wordpad', 'excel': 'excel', 'powerpoint': 'powerpnt', 'word': 'winword'}
...
def take():
    ...
    with sr.Microphone() as source:
        ...
        try:
            print("Recognizing......")
            # it analyze recorded voice through our microphone
            speak("Recognizing......")
...
while True:
    ...
    try:
        ...
        if "open youtube".lower() in text.lower():
            ...
            speak(f"Your Net's Download Speed is {
                  download_wifi} and upload speed is {upload_wifi}......")
            print(f"Your Net's Download Speed is {
                  download_wifi} and upload speed is {upload_wifi}......")
